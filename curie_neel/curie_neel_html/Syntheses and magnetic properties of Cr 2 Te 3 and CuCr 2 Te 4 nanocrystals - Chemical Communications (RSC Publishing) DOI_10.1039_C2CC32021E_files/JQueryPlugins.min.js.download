...
(function ($) {
    ...
    $.Autocompleter = function (input, options) {
        ...
        function selectCurrent() {
            ...
            if (selected.result == "") {
                var v = this.document.forms[0][0].form[0].value;
            } else {
...
(function ($) {
    $.fn.hint = function (blurClass) {
        ...
        return this.each(function () {
            ...
            if (title) {
                if ($input.val() != '' && $input.val() != title && $input.hasClass(blurClass)) {
                    $input.removeClass(blurClass);
                }
                $input.blur(function () {
                    if (this.value === '' || $input.val() === title) {
            ...
            setTimeout(function () {
                ...
                try {
                    if (options.extraData)
                        for (var n in options.extraData) extraInputs.push($('<input type="hidden" name="' + n + '" value="' + options.extraData[n] + '" />').appendTo(form)[0]);
                    $io.appendTo('body');
    ...
    $.fn.lazyload = function (options) {
        ...
        this.each(function () {
            ...
            if (undefined == $(self).attr("original")) {
                $(self).attr("original", $(self).attr("src1"));
            }
